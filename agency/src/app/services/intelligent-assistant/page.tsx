...
export default function IntelligentAssistantPage() {
  ...
  const descriptionText = {
    intro:
      "Meet your new digital teammate, the Intelligent Chat Assistant from Elaria Labs. This isn't just any chatbot, it's a super smart, always on helper that can tackle customer questions, fetch real time data, and even handle multiple chats at once. Imagine having a customer service rep who never sleeps, never gets tired, and always has the right answer at their fingertips. That's our Chat Assistant.",
    conclusion:
